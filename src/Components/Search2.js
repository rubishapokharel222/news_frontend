  ...
  return (
    ...
    <div className='flex mx-8 space-x-7 my-8'>
       ...
       <div className=' border-b-2 border-black '>
        ...
        <div className=" my-14 mx-9">
        {/* image1 */}
        <div className='flex space-x-8 w-full py-8'>
          <img src={travel1} alt="" className="w-72 h-52" />
          <div className="my-3">
            {' '}
            <a href="#">
              {' '}
            ...
            <a href="#">
              <h1 className="text-3xl font-semibold hover:text-blue-700">
            ...
            <h1 className='py-3'>This is an image post format. Note that if you click on the featured image it will open in pop-up full screen.</h1>

          </div>
        </div>
        {/* image2 */}
        <div className='flex space-x-8 w-full'>
          <img src={travel2} alt="" className="w-72 h-52" />
          <div className="my-3">
            {' '}
            <a href="#">
              {' '}
        ...
        {/* image3 */}
        <div className='flex space-x-8 w-full py-8'>
          <img src={travel3} alt="" className="w-72 h-52" />
          <div className="my-3">
            {' '}
            <a href="#">
              {' '}
        ...
        {/* image1 */}
        <div className='flex space-x-8 w-full'>
          <img src={travel4} alt="" className="w-72 h-52" />
          <div className="my-3">
            {' '}
            <a href="#">
              {' '}
     ...
     <div className='text-center'> <Link to="/search"><button className='bg-blue-600 py-1 px-3'>1</button></Link>
     <a href="/search2"><button className='bg-blue-600 py-1 px-3 ml-3'>2</button></a>
     <a href="/search"><button className='bg-blue-600 py-1 px-10 float-left'>PREVIOUS</button></a></div>
       </div>
