  ...
  return (
    ...
    <div className='flex mx-8 space-x-7 my-8'>
       ...
       <div className=' border-b-2 border-green-600 '>
        ...
        <div className='my-5 relative'> <img src={travel} alt="" />
        <div className="absolute bottom-40 text-center left-60">
                  <span className="bg-green-600 p-1.5 text-white text-sm text-center">
                    TRAVEL
                  </span>
        ...
        <div className='flex space-x-4 my-5'>
          <img src={travel3} alt="" className="w-48 h-32" />
          <div className="my-3">
            {' '}
            <a href="#">
              {' '}
        ...
        {/* image1 */}
        <div className='flex space-x-4 my-5'>
          <img src={travel4} alt="" className="w-48 h-32" />
          <div className="my-3">
            {' '}
            <a href="#">
              {' '}
     ...
     <div className='text-center'> <Link to="/travel"><button className='bg-blue-600 py-1 px-3'>1</button></Link>
     <a href="/travel2"><button className='bg-blue-600 py-1 px-3 ml-3'>2</button></a>
     <a href="/travel2"><button className='bg-blue-600 py-1 px-10 float-right'>Next</button></a></div>
       </div>
